...
import * as Accordion from "@tealess/accordion";
...
export const Single = () => {
  ...
  return (
    <>
      ...
      <Accordion.Root type="single" className={rootClass()}>
        <Accordion.Item className={itemClass()} value="one">
          ...
          <Accordion.Content className={contentClass()}>
            Per erat orci nostra luctus sociosqu mus risus penatibus, duis elit vulputate viverra integer ullamcorper congue curabitur sociis, nisi malesuada
            scelerisque quam suscipit habitant sed.
          </Accordion.Content>
        </Accordion.Item>
        <Accordion.Item className={itemClass()} value="two">
          ...
          <Accordion.Content className={contentClass()}>
            Cursus sed mattis commodo fermentum conubia ipsum pulvinar sagittis, diam eget bibendum porta nascetur ac dictum, leo tellus dis integer platea
            ultrices mi.
          </Accordion.Content>
        </Accordion.Item>
        ...
        <Accordion.Item className={itemClass()} value="four">
          ...
          <Accordion.Content className={contentClass()}>
            Odio placerat <a href="#">quisque</a> sapien sagittis non sociis ligula penatibus dignissim vitae, enim vulputate nullam semper potenti etiam
            volutpat libero.
            <button>Cool</button>
          </Accordion.Content>
        </Accordion.Item>
      ...
      <h1>Controlled</h1>
      <Accordion.Root type="single" value={valueOne} onValueChange={setValueOne} className={rootClass()}>
        <Accordion.Item className={itemClass()} value="one">
          <Accordion.Header className={headerClass()}>
            <Accordion.Trigger className={triggerClass()}>One</Accordion.Trigger>
          </Accordion.Header>
            ...
            <Accordion.Content className={animatedContentClass()}>
              {[...Array(count)].map((_, index) => (
                <div style={{ padding: 10 }} key={index}>
                  Per erat orci nostra luctus sociosqu mus risus penatibus, duis elit vulputate viverra integer ullamcorper congue curabitur sociis, nisi
  ...
  return (
    <Accordion.Root type="multiple" value={value} onValueChange={setValue} className={rootClass()}>
      ...
      <Accordion.Item className={itemClass()} value="four">
        ...
        <Accordion.Content className={animatedContentClass()}>
          Odio placerat <a href="#">quisque</a> sapien sagittis non sociis ligula penatibus dignissim vitae, enim vulputate nullam semper potenti etiam volutpat
          libero.
          <button>Cool</button>
        </Accordion.Content>
      </Accordion.Item>
  ...
  return (
    <>
      ...
      <Accordion.Root type="single" className={rootClass()}>
        {items.map((item) => (
          <Accordion.Item key={item} className={itemClass()} value={item}>
            ...
            <Accordion.Content className={contentClass()}>
              {item}: Per erat orci nostra luctus sociosqu mus risus penatibus, duis elit vulputate viverra integer ullamcorper congue curabitur sociis, nisi
              malesuada scelerisque quam suscipit habitant sed.
            </Accordion.Content>
          </Accordion.Item>
        ))}
      ...
      <Accordion.Root type="single" className={rootAttrClass()} defaultValue="Two" disabled={false}>
        {items.map((item) => (
          <Accordion.Item key={item} className={itemAttrClass()} value={item} disabled={["Two", "Four"].includes(item)}>
            <Accordion.Header className={headerAttrClass()}>
              <Accordion.Trigger className={triggerAttrClass()}>{item}</Accordion.Trigger>
            </Accordion.Header>
            <Accordion.Content className={contentAttrClass()}>
      ...
      <Accordion.Root type="single" className={rootAttrClass()} defaultValue="Two" disabled={true}>
        {items.map((item) => (
          <Accordion.Item key={item} className={itemAttrClass()} value={item} disabled={["Two", "Four"].includes(item) ? false : undefined}>
            <Accordion.Header className={headerAttrClass()}>
              <Accordion.Trigger className={triggerAttrClass()}>{item}</Accordion.Trigger>
            </Accordion.Header>
            <Accordion.Content className={contentAttrClass()}>
